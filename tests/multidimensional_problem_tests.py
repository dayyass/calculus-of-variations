...
def make_solution(L: str, t0: float, t1: float, x1_0: float, x1_1: float, x2_0: float, x2_1: float):
    solution = MultidimensionalSolver(L, t0, t1, x1_0, x1_1, x2_0, x2_1)
    solution.solve(verbose=False)
    return solution


test_case_1 = {
    'solution': make_solution(L='x1_diff**2 + x2_diff**2', t0=0, t1=1, x1_0=0, x1_1=1, x2_0=0, x2_1=1),
...
test_case_2 = {
    'solution': make_solution(L='x1_diff ** 2 + x2_diff ** 2', t0=0, t1=1, x1_0=0, x1_1=1, x2_0=1, x2_1=exp(1)),
    'general_solution_1': C1 + C2 * t,
    'general_solution_2': C3 + C4 * t,
...
test_case_3 = {
    'solution': make_solution(
        L='x2 ** 2 + x1_diff ** 2 + x2_diff ** 2', t0=0, t1=1, x1_0=0, x1_1=1, x2_0=1, x2_1=exp(1),
    ),
    'general_solution_1': C1 + C2 * t,
...
test_case_4 = {
    'solution': make_solution(L='x1_diff * x2_diff - x1 * x2', t0=0, t1=pi / 2, x1_0=0, x1_1=1, x2_0=1, x2_1=0),
...
test_case_5 = {
    'solution': make_solution(
        L='2 * x1 + x2 ** 2 + x1_diff ** 2 + x2_diff ** 2', t0=0, t1=1, x1_0=0, x1_1=0.5, x2_0=1, x2_1=exp(-1),
    ),
...
class TestSolver(unittest.TestCase):
    ...
    def test_general_solution_1(self):
        self.assertAlmostEqual(self.solution.general_solution_1, self.general_solution_1)

    def test_general_solution_2(self):
        self.assertAlmostEqual(self.solution.general_solution_2, self.general_solution_2)
    ...
    def test_particular_solution_1(self):
        self.assertAlmostEqual(self.solution.particular_solution_1, self.particular_solution_1)

    def test_particular_solution_2(self):
        self.assertAlmostEqual(self.solution.particular_solution_2, self.particular_solution_2)
