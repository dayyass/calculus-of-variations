...
def make_solution(
        n: int, L: str, t0: float, t1: float, x0: float, x1: float,
...
test_case_1 = {
    'solution': make_solution(n=2, L='x_diff_2 ** 2', t0=0, t1=1, x0=0, x1=0, x0_array=[0], x1_array=[1]),
...
test_case_2 = {
    'solution': make_solution(n=2, L='x_diff_2 ** 2 - 48 * x', t0=0, t1=1, x0=1, x1=0, x0_array=[-4], x1_array=[0]),
...
test_case_3 = {
    'solution': make_solution(n=3, L='x_diff_3 ** 2', t0=0, t1=1, x0=0, x1=1, x0_array=[0, 0], x1_array=[3, 6]),
    'general_solution': Cs[1] + Cs[2] * t + Cs[3] * t**2 + Cs[4] * t**3 + Cs[5] * t**4 + Cs[6] * t**5,
    'coefficients': {Cs[1]: 0, Cs[2]: 0, Cs[3]: 0, Cs[4]: 1, Cs[5]: 0, Cs[6]: 0},
    'particular_solution': t**3,
    'extrema_value': 36,
}
test_case_4 = {
    'solution': make_solution(n=4, L='x_diff_4 ** 2', t0=0, t1=1, x0=0, x1=1, x0_array=[0, 0, 0], x1_array=[3, 6, 10]),
    'general_solution': Cs[1] + Cs[2] * t + Cs[3] * t**2 + Cs[4] * t**3 +
                        Cs[5] * t**4 + Cs[6] * t**5 + Cs[7] * t**6 + Cs[8] * t**7,
    'coefficients': {Cs[1]: 0, Cs[2]: 0, Cs[3]: 0, Cs[4]: 0, Cs[5]: 10/3, Cs[6]: -4, Cs[7]: 2, Cs[8]: -1/3},
